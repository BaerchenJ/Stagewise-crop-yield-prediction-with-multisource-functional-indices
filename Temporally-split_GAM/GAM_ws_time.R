...
k = 5  # all k values bring negative R^2, thus we use the smallest k = 5 here.
...
#write.xlsx(data.frame(do.call(rbind, res)), "TuneK\\GAM_ws_time.xlsx")
...
write.xlsx(data.frame(r2list, rmselist), "Tsplit_Res\\GAM_ws_time.xlsx")
