...
resi_train_8 <- import("S2Res\\GAMM4D2D_train.xlsx")
...
resi_train_43 <- import("S1Res\\GAMM4D_train.xlsx") # to convert back to original scale, we need data of 43 years
...
resi_valid_8 <- import("S2Res\\GAMM4D2D_valid.xlsx")
...
resi_valid_43 <- import("S1Res\\GAMM4D_valid.xlsx") 
...
resi_test_8 <- import("S2Res\\GAMM4D2D_test.xlsx")
...
resi_test_43 <- import("S1Res\\GAMM4D_test.xlsx") # to convert back to original scale, we need data of 43 years
...
write.xlsx(resdf, "TuneK\\GAMM4D2D_IndexSelection.xlsx")
...
#for (cc in 1:ncol(trainrimean)){
  ...
  s3gam <- gam(y3_train~te(RI1, RI2, RI3, RI4, k = k, bs = "ps"), method = "REML")
...
write.xlsx(resdf, "TuneK\\GAMM4D2D_NDVIEVISATVISAVI.xlsx")
