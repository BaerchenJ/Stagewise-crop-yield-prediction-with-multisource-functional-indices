...
resi_train_8 <- import("S2Res\\BSVFM-GAMW1D_train.xlsx")
...
gamlist = list(gamw1, gamw2, gamw3, gamw4, gamw5, 
  ...
  resi_valid_8 <- import("S2Res\\BSVFM-GAMW1D_valid.xlsx")
  ...
  resi_test_8 <- import("S2Res\\BSVFM-GAMW1D_test.xlsx")
...
write.xlsx(resdf, "TuneK\\BSVFM-GAMW-GAMW-1D1D_IndexSelection.xlsx")
...
write.xlsx(resdf, "TuneK\\BSVFM-GAMW-GAMW-1D1D_NDVIEVI.xlsx")
