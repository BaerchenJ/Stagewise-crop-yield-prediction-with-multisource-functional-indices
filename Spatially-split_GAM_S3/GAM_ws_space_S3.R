...
resi_train_8 <- import("S2Res\\GAM_ws_space_S2_train.xlsx")
...
gamlist = list(gamw1, gamw2, gamw3, gamw4, gamw5, 
  ...
  resi_train_43 <- import("S1Res\\GAM_ws_space_S1_train.xlsx") # to convert back to original scale, we need data of 43 years
  ...
  resi_valid_8 <- import("S2Res\\GAM_ws_space_S2_valid.xlsx")
  ...
  resi_test_8 <- import("S2Res\\GAM_ws_space_S2_test.xlsx")
  ...
  resi_test_43 <- import("S1Res\\GAM_ws_space_S1_test.xlsx") # to convert back to original scale, we need data of 43 years
...
#write.xlsx(resdf, "TuneK\\GAM_ws_space_S3_IndexSelection.xlsx")

#write.xlsx(resdf, "TuneK\\GAM_ws_space_S3_TSAVI_5.xlsx")
...
write.xlsx(data.frame(r2vec_s1, r2vec_s2, r2vec_s3, rmsevec_s1, rmsevec_s2, rmsevec_s3), "S3Res\\GAM_ws_space_S3_TSAVI_result.xlsx")
...
write.xlsx(traindf, "S3Res\\GAM_ws_space_S3_TSAVI_train.xlsx")

validdf <- data.frame(resi_valid_5, 
                      Fit3 = validpreds, 
                      Resi3 = y3_valid - validpreds)

write.xlsx(validdf, "S3Res\\GAM_ws_space_S3_TSAVI_valid.xlsx")

testdf <- data.frame(resi_test_5, 
                     Fit3 = testpreds, 
                     Resi3 = y3_test - testpreds)

write.xlsx(testdf, "S3Res\\GAM_ws_space_S3_TSAVI_test.xlsx")
